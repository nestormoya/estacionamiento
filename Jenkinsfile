  ...
  stages{
    ...
    stage('Unit Tests') {
      steps{
        ...
        sh 'xcodebuild -workspace estacionamiento.xcworkspace -scheme "estacionamiento" -configuration "Debug" test -destination "platform=iOS Simulator,name=iPhone 11,OS=14.5"'
      }
    }
